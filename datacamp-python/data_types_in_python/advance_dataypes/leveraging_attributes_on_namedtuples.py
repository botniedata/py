...
SpeciesDetails = namedtuple('SpecialDetails', ['species', 'sex', 'body_mass'])

# Loaded dataset: labeled_entries
...
for entry in labeled_entries[:20]:
    ...
    # Print each entry's sex and body_masss separated by a colon
