...
# Use a list comprehension to iterate over each penguins save as female_species_list
# If the sex of the penguin is 'FEMALE' retunn the species value
